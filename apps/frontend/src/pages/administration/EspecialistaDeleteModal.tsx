...
export const EspecialistaDeleteModal = ({ especialista, onConfirm, onCancel }: Props) => (
    ...
    <div className="w-full max-w-[400px] bg-surface border border-border rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.12)] overflow-hidden">
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="text-center">
          <h3 className="text-text font-bold text-base mb-1">Eliminar Especialista</h3>
          <p className="text-text-muted text-sm leading-relaxed">
            ¿Está seguro que desea eliminar a{' '}
            <strong className="text-text">{especialista.nombres}</strong>?
          </p>
        </div>
        ...
        <div className="bg-bg border border-border rounded-xl px-4 py-3 flex flex-col gap-1.5">
          <div className="flex justify-between text-xs">
            ...
            <span className="text-text font-mono font-semibold">{especialista.dni}</span>
          </div>
          <div className="flex justify-between text-xs">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span className="text-text font-semibold">{especialista.especialidad}</span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2 bg-danger/5 border border-danger/20 rounded-xl px-3.5 py-3">
          ...
          <p className="text-danger text-xs leading-relaxed">
            Esta acción es irreversible. Se eliminarán todos los datos y accesos asociados a este
            especialista.
          </p>
        </div>
