...
import { CreateEspecialistaCard } from '@widgets/especialistas';
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <PageHeader
            ...
            description="Complete los datos para dar de alta un nuevo especialista de monitoreo de la UGEL."
          />
        </div>
      </div>

      <CreateEspecialistaCard />
    </div>
  );
};
