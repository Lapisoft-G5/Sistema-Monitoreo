...
import { EditEspecialistaCard } from '@widgets/especialistas';
    ...
    <div className="flex flex-col gap-6 max-w-[820px] mx-auto w-full animate-in fade-in-0 duration-300">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <PageHeader
            title="Modificar Datos de Especialista"
            description="Actualice el perfil profesional o de contacto del especialista seleccionado."
          />
        </div>
      </div>

      <EditEspecialistaCard />
    </div>
  );
};
