        ...
        <div className="flex flex-col gap-6">
          <Card className="p-6 border border-border shadow-xs flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <div>
                <span className="text-[0.68rem] text-text-muted uppercase font-bold tracking-wider block">Especialidad / Área</span>
                <span className="text-sm font-semibold text-text">{jefe.especialidad}</span>
              </div>
              <div>
