...
export const JefeGestionCreatePage = () => {
    ...
    <div className="flex flex-col gap-6 max-w-[820px] mx-auto w-full animate-in fade-in-0 duration-300">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <PageHeader
            title="Registrar Nuevo Jefe de Gestión"
            description="Complete los datos para dar de alta un Coordinador Pedagógico (Jefe de Gestión)."
          />
        </div>
      </div>
      ...
      <CreateDocenteCard 
        ...
        submitLabel="Guardar Jefe de Gestión"
      />
    </div>
  );
};
